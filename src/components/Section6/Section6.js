...
const Section6 = () => {
    return (
        <div className='lg:flex lg:flex-row w-11/12 max-w-[1320px] mx-auto lg:gap-9 px-10 pb-10'>
            ...
            {/* <form className='lg:flex lg:flex-col  mx-auto lg:gap-3' onSubmit={(e) => { e.preventDefault(); console.log("form submitted"); }}>
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                <div
                    ...
                    <LabelInputContainer>
                        ...
                        <Input id="firstname" placeholder="Parth" type="text" />
                    </LabelInputContainer>
                    <LabelInputContainer>
                ...
                <LabelInputContainer className="mb-4">
                    ...
                    <Input id="email" placeholder="nbparthgupta4959@gmail.com" type="email" />
                </LabelInputContainer>
                <LabelInputContainer className="mb-4">
