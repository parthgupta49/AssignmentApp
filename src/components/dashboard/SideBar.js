...
const SideBar = () => {
    ...
    return (
        <div className={`${confirmModal ? "bg-white " : ""}`}>
            <div className='flex min-w-[222px] flex-col border-r-[1px] border-r-richblack-700  min-h-full bg-richblack-800 lg:pt-[10%] '>
                
                <div className='text-gray-300 ml-10 font-bold text-xl mb-10'>Dashboard</div>
                {
