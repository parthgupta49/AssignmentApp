...
export const MaskContainer = ({
    ...
    return (
        (<motion.div
            ...
            animate={{
                backgroundColor: isHovered ? "var(--slate-900)" : "var(--richblack-800)",
            }}>
            <motion.div
            ...
            <div className="w-[80%] h-full flex flex-col items-center justify-center gap-10 text-white font-medium text-xl mx-auto">
                {revealText}
                <br/>
                <p>
