...
const VerifyEmail = () => {
    ...
    return (
        <div className='min-h-screen grid place-items-center bg-richblack-800'>
            {
                loading ? (<>Loading...</>) : (
                    <div>
                        ...
                        <form onSubmit={handleOnSubmit}>
                            <OtpInput
                                ...
                                renderInput={(props) => <input {...props}
                                    ...
                                    className="lg:w-[85px] border border-richblack-300 bg-richblack-800 rounded-[0.5rem] focus:outline-none text-richblack-5 aspect-square text-center text-3xl font-medium focus:border-0 focus:outline-2 focus:outline-yellow-50"
                        ...
                        <div className='flex justify-between mt-5 items-center' >
                            <Link to="/login">
                                <p className='text-yellow-200 font-medium flex items-center gap-x-2'>Back to Login</p>
                            </Link>
                            <button className='flex font-medium items-center text-blue-100 gap-x-2' onClick={() => dispatch(sendOtp(signupData.email, navigate))}>
                                Resend it
                            </button>
                        </div>
                    </div>
